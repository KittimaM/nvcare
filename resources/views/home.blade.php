...
<html>
  <head>
    ...
    <link href="{{ asset('slide/css/owl.theme.default.min.css') }}" rel="stylesheet">
    <link href="{{ asset('slide/css/owl.carousel.min.css') }}" rel="stylesheet">
    <link href="{{ asset('slide/css/style.css') }}" rel="stylesheet">
    <link href="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/ionicons/4.5.6/css/ionicons.min.css') }}" rel="stylesheet">
